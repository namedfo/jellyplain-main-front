...
export default function MobileMenu() {
    return (
        <div className="shadow-jj md:hidden flex justify-around items-center px-[20px] h-[50px] rounded-[10px] bg-white w-[95%] fixed bottom-[20px] left-[2.5%]">
            <button className='hover:bg-[#8045C61A] rounded-[10px] p-[5px]'>
                <HiHome color="#a67fd4" size={30} />
            </button>
            <button className='hover:bg-[#8045C61A] rounded-[10px] p-[5px]'>
