    ...
    <div className="flex flex-col">
      ...
      <div className="relative shadow-jj mt-[10px] md:mt-[30px] p-[15px] flex flex-row sm:flex-col justify-center items-center rounded-[10px] bg-white w-full sm:w-[240px]">
        ...
        <button
          ...
          className={`${menuActive.name === "orders" ? "text-white bg-fuchsia-500" : "text-[#86368d] hover:bg-[#8A63B91A]"} mt-[20px] sm:mt-[15px] w-[98%] rounded-[10px] py-[4px] font-medium text-[16px]`}
        >
          Заказы
        </button>
        <button
          onClick={() => onHandleChangeMenu("settings")}
          className={`${menuActive.name === "settings" ? "text-white bg-fuchsia-500" : "text-[#86368d] hover:bg-[#8A63B91A]"} mt-[20px] sm:mt-[15px] w-[98%] rounded-[10px] py-[4px] font-medium text-[16px]`}
        >
          Настройки
        </button>
      </div>
