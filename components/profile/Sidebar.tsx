    ...
    <div className="flex flex-col">
      ...
      <div className="relative shadow-jj mt-[10px] md:mt-[30px] p-[15px] flex flex-row sm:flex-col justify-center items-center rounded-[10px] bg-white w-full sm:w-[240px]">
        ...
        <button
          ...
          className={`${menuActive.name === "orders" ? "text-white bg-[#86368d]" : "text-[#86368d] hover:bg-[#8A63B91A]"} mt-[20px] sm:mt-[15px] w-[98%] rounded-[10px] py-[5px] font-medium text-[18px]`}
        >
          Заказы
        </button>
        <button
          onClick={() => onHandleChangeMenu("settings")}
          className={`${menuActive.name === "settings" ? "text-white bg-[#86368d]" : "text-[#86368d] hover:bg-[#8A63B91A]"} mt-[20px] sm:mt-[15px] w-[98%] rounded-[10px] py-[5px] font-medium text-[18px]`}
        >
          Настройки
        </button>
      </div>
